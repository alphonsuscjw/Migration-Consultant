...
//const url = "https://github.com/rohanliyanage/test3/blob/main/output.js"

var out = "file://localhost/c:/Users/Rohan/Documents/BOOTCAMP/16-Project-3-Data-Ethics/assignment/output.json"

// Fetch the JSON data and console log it
d3.json(out).then(function(data) {
  console.log(data);
});
...
function init() {
    ...
    d3.json(url).then((data) => {
        ...
        buildBubbleChart(output_one);
        buildGaugeChart(output_one);
